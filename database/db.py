...
def _seed_demo(conn):
    ...
    phases = [
        ("Cadrage & Besoins", d(-10), d(0), "Terminé", 100, "V1", "#4C78A8"),
        ("Conception", d(0), d(15), "En cours", 60, "V1", "#F58518"),
        ("Développement", d(12), d(40), "En cours", 25, "V2", "#54A24B"),
        ("Tests & Validation", d(38), d(52), "À faire", 0, "V1", "#E45756"),
        ("Déploiement", d(50), d(60), "À faire", 0, "V1", "#72B7B2"),
    ]
    phase_ids = []
